...
<body class="text-white">
    ...
    <section class="hero-bg min-h-screen flex items-center py-20 lg:py-0 relative overflow-hidden">
        ...
        <div class="orbit-container">
            ...
            <!-- Original 4 -->
            <div class="orbit-eye-wrapper"
                style="animation-name: orbit-path-1; animation-duration: 18s; animation-delay: 0s; --glow-color: #ff5e3a;">
                <img src="assets/img/eyes/eye1.png" alt="Creative Vision 1" class="orbit-eye" />
            </div>
            <div class="orbit-eye-wrapper"
                style="animation-name: orbit-path-2; animation-duration: 22s; animation-delay: -5s; --glow-color: #00bfff;">
                <img src="assets/img/eyes/eye2.png" alt="Creative Vision 2" class="orbit-eye" />
            </div>
            <div class="orbit-eye-wrapper"
                style="animation-name: orbit-path-3; animation-duration: 25s; animation-delay: -12s; --glow-color: #d63384;">
                <img src="assets/img/eyes/eye3.png" alt="Creative Vision 3" class="orbit-eye" />
            </div>
            <div class="orbit-eye-wrapper"
                style="animation-name: orbit-path-4; animation-duration: 20s; animation-delay: -8s; --glow-color: #fd7e14;">
                <img src="assets/img/eyes/eye4.png" alt="Creative Vision 4" class="orbit-eye" />
            </div>

            <!-- Duplicated 4 (Swarming) -->
            <div class="orbit-eye-wrapper"
                style="animation-name: orbit-path-2; animation-duration: 28s; animation-delay: -15s; animation-direction: reverse; --glow-color: #ff5e3a;">
                <img src="assets/img/eyes/eye1.png" alt="Creative Vision 1" class="orbit-eye" />
            </div>
            <div class="orbit-eye-wrapper"
                style="animation-name: orbit-path-3; animation-duration: 19s; animation-delay: -2s; animation-direction: reverse; --glow-color: #00bfff;">
                <img src="assets/img/eyes/eye2.png" alt="Creative Vision 2" class="orbit-eye" />
            </div>
            <div class="orbit-eye-wrapper"
                style="animation-name: orbit-path-4; animation-duration: 24s; animation-delay: -18s; animation-direction: reverse; --glow-color: #d63384;">
                <img src="assets/img/eyes/eye3.png" alt="Creative Vision 3" class="orbit-eye" />
            </div>
            <div class="orbit-eye-wrapper"
                style="animation-name: orbit-path-1; animation-duration: 26s; animation-delay: -10s; animation-direction: reverse; --glow-color: #fd7e14;">
                <img src="assets/img/eyes/eye4.png" alt="Creative Vision 4" class="orbit-eye" />
            </div>
        </div>

        <div
            class="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center w-full relative z-10 pointer-events-none">
            ...
            <div class="pointer-events-auto">
                ...
                <div class="flex gap-4">
                    ...
                    <button onclick="redirectToEvents()"
    ...
    <section id="about-us" class="py-28 px-6 relative overflow-hidden">
        <div
            class="absolute top-0 right-0 w-96 h-96 bg-red-600 rounded-full blur-[180px] opacity-10 pointer-events-none">
        </div>
        <div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative group">
                <div
                    class="absolute -inset-1.5 bg-gradient-to-r from-red-600 to-pink-600 rounded-2xl blur-lg opacity-40 group-hover:opacity-75 transition duration-1000 group-hover:duration-200">
                </div>
                <div class="relative bg-black rounded-2xl overflow-hidden border border-white/10">
                    <img src="assets/img/about-manifesto.png" alt="Manifesto of Resistance"
                        class="w-full h-[450px] object-cover scale-100 group-hover:scale-105 transition-transform duration-700" />
                </div>
            </div>
            ...
            <div>
                ...
                <p class="text-gray-300 text-lg leading-relaxed mb-6">
                    JemisArt is more than an art space; it is a movement born out of the necessity to express,
                    challenge, and break boundaries. In a world that constantly demands conformity, creative expression
                    becomes our most potent form of defiance.
                </p>
                <p class="text-gray-400 text-base leading-relaxed mb-10">
                    Whether it is the stroke of a brush, a physical movement, the resonance of a chord, or a theatrical
                    voice—every piece of art is a statement. We provide the tools, the sanctuary, and the canvas for
                    creators to stand tall and speak their truths.
                </p>
    ...
    <section id="journey" class="py-28 px-6 bg-gradient-to-b from-transparent via-white/[0.02] to-transparent">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <!-- Step 01 -->
                <div class="glass p-8 rounded-2xl journey-card flex flex-col justify-between h-[280px] cursor-pointer"
                    style="--journey-glow: #ff5e3a;">
                    <div>
                        ...
                        <p class="text-gray-400 text-sm leading-relaxed">
                            Explore painting, dancing, acting, or music to discover your unique artistic medium of
                            expression.
                        </p>
                    </div>
                ...
                <div class="glass p-8 rounded-2xl journey-card flex flex-col justify-between h-[280px] cursor-pointer"
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 text-sm leading-relaxed">
                            Join a workspace and connect with fellow creators, local mentors, and supportive art
                            collectives.
                        </p>
                    </div>
                ...
                <div class="glass p-8 rounded-2xl journey-card flex flex-col justify-between h-[280px] cursor-pointer"
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 text-sm leading-relaxed">
                            Collaborate, experiment, and fuel the fire of creation, pushing the boundaries of
    ...
    <section id="events" class="py-28 px-6 relative overflow-hidden bg-black/50">
        <div
            class="absolute top-0 left-0 w-96 h-96 bg-purple-600 rounded-full blur-[180px] opacity-10 pointer-events-none">
        </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <?php else: ?>
                    <?php foreach ($events as $event): ?>
                        ...
                        ?>
                        <div class="glass rounded-2xl overflow-hidden group cursor-pointer border border-white/5 hover:border-[<?= $colorValue ?>]/30 transition-all duration-500 flex flex-col h-full"
                            ...
                            <div class="p-6 flex flex-col flex-1 relative">
                                ...
                                <div
                                    ...
                                    <a href="views/landing/event-details.php?id=<?= $event['id'] ?>"
    ...
    <section id="partners" class="py-24 px-6 relative">
        <div
            class="absolute bottom-0 left-0 w-80 h-80 bg-pink-600 rounded-full blur-[150px] opacity-10 pointer-events-none">
        </div>
        <div class="max-w-7xl mx-auto">
                ...
                <?php else: ?>
                    ...
                    <div class="flex animate-marquee w-max gap-8 pr-8">
                        <?php foreach ($displayPartners as $index => $partner): ?>
                            ...
                            ?>
                            <div class="shrink-0 w-[280px] border border-white/5 rounded-2xl p-8 flex items-center justify-center partner-card cursor-pointer h-32"
                                style="--partner-glow: <?= $color ?>; --partner-glow-shadow: <?= str_replace('0.3', '0.15', $color) ?>;">
                                <?php if ($logoUrl): ?>
                                    <img src="<?= htmlspecialchars($logoUrl) ?>" alt="<?= htmlspecialchars($partner->getLabel()) ?>"
                                        class="max-h-full max-w-full object-contain filter grayscale hover:grayscale-0 transition duration-500" />
                                <?php else: ?>
                                    <span
                                        class="font-['Anton'] text-2xl tracking-widest text-white uppercase text-center"><?= htmlspecialchars($partner->getLabel()) ?></span>
                                <?php endif; ?>
                            </div>
                        <?php endforeach; ?>
                    </div>
    ...
    <section class="py-20 px-6">
        <div class="max-w-5xl mx-auto">
            ...
            <div
                class="cta-glass-card rounded-3xl p-10 md:p-16 border border-white/10 flex flex-col md:flex-row justify-between items-center gap-10">
                <div class="relative z-10 max-w-xl text-center md:text-left">
                    <h2 class="text-4xl md:text-5xl title-font mb-4">
                        READY TO <span class="gradient-text">JOIN THE FORCE?</span>
                    </h2>
                    <p class="text-gray-300 text-base leading-relaxed">
                        Step inside the House of Resistance. Register now to share your location, showcase your
                        creations, and collaborate with standard and admin creators.
                    </p>
                </div>
                <div class="relative z-10 shrink-0">
                    <button onclick="redirectToSignIn()"
                        class="bg-red-600 hover:bg-red-700 text-white font-semibold text-lg px-10 py-5 rounded-full transition shadow-lg shadow-red-600/20 hover:shadow-red-600/40 cursor-pointer">
                        Enter The House
                    </button>
                </div>
            </div>
    ...
    <script>
        ...
        function redirectToGallery() {
            window.location.href = 'views/landing/gallery.php';
        }

        function redirectToEvents() {
            window.location.href = 'views/landing/events.php';
        }
    </script>
</body>
